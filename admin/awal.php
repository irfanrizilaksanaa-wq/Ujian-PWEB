...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
          ...
          <ul class="nav navbar-top-links navbar-right">
            <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#">
               <img src="../images/admin/<?php echo $dataAdmin['foto']; ?>" height="50"></i> <?php echo $dataAdmin['nama_admin']; ?>
              </a>
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Selamat Datang, <?php echo $dataAdmin['nama_admin']; ?></h1>
          </div>
        </div>
...
<p class="text-muted" style="font-size: 16px;"> Tugas Ujian &copy; <script>document.write(new Date().getFullYear());</script> Pemrograman Web Yugi dan Aldo</p>
            </div>
          </div>
        </div>
      </div>
